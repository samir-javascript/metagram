...
import { setMessagese, setSelectedConversation } from "../../slices/conversationSlice"
import useListenMessages from "../../utils/useListenMessages"
import { FaArrowLeft, FaArrowRight } from "react-icons/fa"
const MessageConveForMobile = () => {
...
useEffect(() => {
  ...
  return (
    <section className="flex-1 flex !p-0 !m-0  flex-col h-screen w-full">
{selectedConvesation ? (
  <>
  <div className="fixed z-[99] dark:bg-black bg-white 
   p-4 top-0 w-full border-b dark:border-[#222] ">
    <div className="flex items-center justify-between gap-4">
      <div>
         <FaArrowLeft onClick={()=> handleReset()} className="mr-4 text-black dark:text-white" size={24} />
      </div>
...
export default MessageConveForMobile